...
struct ConditionalArgPartOrConsequent; // F2023 R1526
...
struct ConditionalArg {
  ...
  struct Consequent { // F2023 R1527
    ...
    std::variant<common::Indirection<Expr>, Nil> u;
  };
  std::tuple<ScalarLogicalExpr, Consequent,
      common::Indirection<ConditionalArgPartOrConsequent>>
      t;
};

struct ConditionalArgPartOrConsequent {
  UNION_CLASS_BOILERPLATE(ConditionalArgPartOrConsequent);
