...
static void EmitConditionalArgInner(llvm::raw_ostream &o,
    const ActualArgument::ConditionalArg &ca) {
  auto emitConsequent{[&](const ActualArgument::ConditionalArg::Consequent &cons) {
    if (cons) {
