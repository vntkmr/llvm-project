...
TYPE_PARSER(construct<ConditionalArg>(
    scalarLogicalExpr / "?", Consequent / ":",
    indirect(Parser<ConditionalArgPartOrConsequent>{})))

// conditional-arg-part-or-consequent -> conditional-arg | consequent
TYPE_PARSER(construct<ConditionalArgPartOrConsequent>(Parser<ConditionalArg>{}) ||
    construct<ConditionalArgPartOrConsequent>(Consequent))
